            ...
            <div className="order-2 lg:order-1">
              ...
              <FadeIn delay={0.3}>
                <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-xl leading-relaxed">
                  ...
                  of people actively searching for your services — starting this month.
                </p>
              </FadeIn>
            ...
            <div className="order-1 lg:order-2">
              <FadeIn direction="left" delay={0.3}>
                <div className="relative">
                  <div className="aspect-video rounded-2xl overflow-hidden shadow-glow bg-card border border-border">
                    {/* Video placeholder - will be replaced with Bunny Stream */}
                    <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-brand-purple/20 via-brand-magenta/10 to-brand-cyan/20">
                  ...
                  <motion.div
                    ...
                    className="absolute -bottom-4 -left-4 md:-left-8 bg-card border border-border rounded-xl p-4 shadow-lg"
                  >
