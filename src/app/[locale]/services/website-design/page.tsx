...
import { ArrowRight, Zap, Smartphone, Search, Palette, Code2, Gauge, CheckCircle } from "lucide-react";
...
export default function LocaleWebDesignPage({ params }: LocaleWebDesignPageProps) {
