...
export default function PaidAdsPageClient({ params }: LocalePaidAdsPageProps) {
  ...
  const content = {
    us: {
      ...
      stats: [{ value: 11, suffix: "x", label: "Average ROAS" }, { value: 8, suffix: ".2x", label: "Peak ROAS" }, { value: 40, suffix: "%", label: "Lower Cost Per Lead" }],
    ...
    nl: {
      ...
      stats: [{ value: 11, suffix: "x", label: "Gemiddelde ROAS" }, { value: 8, suffix: ".2x", label: "Hoogste ROAS" }, { value: 40, suffix: "%", label: "Lagere Kosten Per Lead" }],
    ...
    dk: {
      ...
      stats: [{ value: 11, suffix: "x", label: "Gennemsnitlig ROAS" }, { value: 8, suffix: ".2x", label: "Højeste ROAS" }, { value: 40, suffix: "%", label: "Lavere Pris Per Lead" }],
